package thenoble.character;

import static thenoble.TheNoble.characterPath;
...
import thenoble.cards.basic.Diatribe;
import thenoble.cards.basic.Dissemble;
import thenoble.cards.basic.Preempt;
import thenoble.cards.basic.Slap;
...
public class MyCharacter extends CustomPlayer {
  ...
  private static final String ID =
      makeID("Noble"); // This should match whatever you have in the CharacterStrings.json file
  ...
  public static class Meta {
    ...
    // game was made.
    @SpireEnum public static PlayerClass THE_NOBLE;

    @SpireEnum(
        name =
            "CHARACTER_PINK_COLOR") // These two MUST match. Change it to something unique for your
    // character.
  ...
  public ArrayList<String> getStartingDeck() {
    ...
    retVal.add(Slap.ID);
    retVal.add(Slap.ID);
    retVal.add(Dissemble.ID);
    retVal.add(Dissemble.ID);
    retVal.add(Dissemble.ID);
    retVal.add(Dissemble.ID);
    retVal.add(Preempt.ID);
    retVal.add(Diatribe.ID);
