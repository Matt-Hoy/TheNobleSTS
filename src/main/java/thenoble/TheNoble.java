...
import thenoble.util.TextureLoader;
...
public class TheNoble
        ...
        Arrays.stream(Loader.MODINFOS)
            .filter(
                (modInfo) -> {
                  ...
                  return initializers.contains(TheNoble.class.getName());
                })
            .findFirst();
    if (infos.isPresent()) {
      info = infos.get();
  ...
  public void receiveEditCards() {
    new AutoAdd(modID) // Loads files from this mod
        .packageFilter(NobleCard.class) // In the same package as this class
