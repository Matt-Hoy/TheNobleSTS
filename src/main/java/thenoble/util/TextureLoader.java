package thenoble.util;

import static thenoble.TheNoble.*;
...
public class TextureLoader {
  ...
  /**
   * @param filePath - String path to the texture you want to load relative to resources, Example:
   *     imagePath("missing.png")
   * @return <b>com.badlogic.gdx.graphics.Texture</b> - The texture from the path provided, or a
   *     "missing image" texture if it doesn't exist.
   */
   ...
   * @param filePath - String path to the texture you want to load relative to resources, Example:
   *     imagePath("missing.png")
   * @return <b>com.badlogic.gdx.graphics.Texture</b> - The texture from the path provided, or null
   *     if it doesn't exist.
   */
  ...
  public static String getCardTextureString(
      final String cardName, final AbstractCard.CardType cardType) {
    String textureString =
        imagePath("cards/" + cardType.name().toLowerCase(Locale.ROOT) + "/" + cardName + ".png");
  ...
  private static void loadTexture(final String textureString, boolean linearFilter)
